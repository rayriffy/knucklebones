...
<section class="flex space-x-4 items-start justify-center relative {extendedClass}">
      ...
      <div class="bg-white w-2/5  mx-auto rounded-lg shadow-2xl z-50">
        ...
        <div class="grid grid-cols-2 p-6 gap-6">
          <div>
            ...
            <p class="mt-4 font-medium text-center">When dice of the same number are placed in the same column, multiply their value.</p>
          </div>
          <div>
            ...
            <p class="mt-4 font-medium text-center">Destroy your opponents dice by matching yours to theirs in the same column.</p>
          </div>
  ...
  <div class="absolute left-0 bottom-0 space-y-4">
    <button class="inline-flex items-center text-gray-600 font-medium text-sm" on:click={() => isHelpOpen = true}>
      How to play
